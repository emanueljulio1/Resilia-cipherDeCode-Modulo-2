function myFunction(){
    if(document.getElementById("selecionaCifra").value == "cesar"){
        ...
        document.getElementById("base_64").style.display = "none";
        
    }
    else if(document.getElementById("selecionaCifra").value == "base_64"){
        
        document.getElementById("base_64").style.display = "flex";
...
function b(){
    ...
    var entrada = document.getElementById("inputBase_64").value;
    var saida = document.getElementById("base_64Resultado"); 
